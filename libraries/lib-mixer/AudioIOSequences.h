...
struct MIXER_API PlayableSequence : WideSampleSequence {
   ...
   //! bitswype fork: 128-bit mask of device output channels this sequence
   //! plays on during multi-channel playback.  Empty mask = silent.
   //! Default is empty; WaveTrack overrides this to forward the user's
   //! choice from the Playback Routing dialog.  Decorators of
   //! PlayableSequence (e.g. StretchingSequence) MUST forward this call
