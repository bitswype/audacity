...
unsigned ComputeRoutingDialogColumnCount(
    unsigned deviceChannels, const std::vector<PlaybackOutputMask>& trackMasks, const std::vector<unsigned>& trackChannelCounts);
...
unsigned CountTracksWithBitsAboveDeviceWidth(
    unsigned deviceChannels, const std::vector<PlaybackOutputMask>& trackMasks);
